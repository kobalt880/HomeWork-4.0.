...
class Athlete:
    def __init__(self, name: str, age: int, sport_type: str, 
                 achievements: list[str], status: str):
        self.set_name(name)
        self.set_age(age)
    ...
    def set_sport_type(self, new: str):
        if isinstance(new, str):
            ...
            raise ValueError
    def set_achievements(self, new: list[str]):
        if isinstance(new, list) and all([isinstance(e, str) for e in new]):
    ...
    def add_achievement(self, achievement: str):
        if isinstance(achievement, str) and achievement not in self.__achievements:
            self.__achievements.append(achievement)
    
    def remove_achievement(self, achievement: str):
        if isinstance(achievement, str) and achievement in self.__achievements:
